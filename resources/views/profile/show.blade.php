                    ...
                    <div class="flex items-center space-x-8">
                        ...
                        <div class="relative">
                            <div class="w-32 h-32 rounded-full overflow-hidden bg-gray-800 border border-gray-700">
                                <img src="https://media.istockphoto.com/id/1437816897/photo/business-woman-manager-or-human-resources-portrait-for-career-success-company-we-are-hiring.jpg?s=612x612&w=0&k=20&c=tyLvtzutRh22j9GqSGI33Z4HpIwv9vL_MZw_xOE19NQ=" alt="" class="w-full h-full object-cover">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-4">
                                <h1 class="text-2xl font-medium text-gray-100">{{ $user->name}}</h1>
                                <a href="{{ route('profile.edit', ['user' => $user->id]) }}" class="bg-gray-800 text-gray-300 px-4 py-2 rounded border border-gray-700 hover:bg-gray-700 transition">
                                    Edit profile
                                </a>
                                <button class="bg-gray-800 text-gray-300 px-4 py-2 rounded border border-gray-700 hover:bg-gray-700 transition">
                                    View archive
                                </button>
                            </div>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div class="border-b border-gray-700 mb-8">
                            <nav class="-mb-px flex justify-center space-x-8">
                                <a href="#" class="border-b-2 border-white py-4 px-1 inline-flex items-center text-sm font-medium text-white">
